...
import { AdhesionProgressSidebar } from '@/components/adhesion/adhesion-progress-sidebar'
...
export default function AdhesionPage() {
  ...
  return (
    <>
      ...
      {/* Light header — per PDF 08 (formulaire d'adhésion) */}
      ...
      <section className="section" id="formulaire" aria-labelledby="formulaire-title">
        <div className="container">
          ...
          <div className="adhesion-page-grid">
            <div>
              <AdhesionForm />
            </div>
            <AdhesionProgressSidebar />
          </div>
        </div>
      </section>
    </>
